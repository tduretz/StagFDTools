...
@views function anisotropic(nc, BC_template, D_template, factorization, ηn, δ, θ)
    #--------------------------------------------#   
...
@views function main(nc, layering, BC_template, D_template, factorization, η1 , η2; useMarkers = false, nmpc)
    #--------------------------------------------#   
