...
@views function main(nc)
    ...
    anim = @animate for it=1:nt
        ...
        p3 = plot!([1:it].*Δ.t,  probes.τf[1:it], label="τ fluid")
        p3 = plot!([1:it].*Δ.t,  probes.τs[1:it], label="τ solid")
        p3 = plot!([1:it].*Δ.t,  probes.τt[1:it], label="τ total")
        p3 = plot!([1:it].*Δ.t,  probes.Pf[1:it], label="P fluid")
        p3 = plot!([1:it].*Δ.t,  probes.Ps[1:it], label="P solid")
        p3 = plot!([1:it].*Δ.t,  probes.Pt[1:it], label="P total")
